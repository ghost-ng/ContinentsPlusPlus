...
|------|-------------|--------|-------|
| 2026-08-16 (v3 run 6, re-validation batch A/B/C) | Step 5 | **PASS — 0 failures ×3** | Batch of 3 SP runs, all suite-green. **A (Standard/Many)**: rolled 5+2, groups 3, water 63.9%, distant 19.0%, flood-fill 7 physical = rolled, biomes latitude-banded. **B (Huge/Random)**: rolled 6+3, groups 3, water 58.4% (LOW — below 62-68 band), distant 24.3% (high); 6+3 majors verified + one 27-tile region-1 fragment. **C (Tiny/Few)**: rolled 2+1, groups 1, water 70.5% (HIGH), distant landmass only 47 tiles (13.7% share), 16 small islands — map visually poor (blobby pair + island debris). Trend: water% spread widens at size extremes (Huge under, Tiny over) → size-dependent `totalLandmassSize` correction needed, and Tiny distant budget (3 after ×0.75) is too small to make a real landmass. |
